...
(function($) {
    ...
    var insertTweakInterface = function() {
        ...
        // styling
        var styleContent = [
            '.tweakdashboard.main {position:fixed !important; z-index:999999; top:0; left:0; background-color:#ff0000;}',
            '.tweakdashboard.main .commands .button.inactive {color:#666666;}',
    ...
    var updateCurrentHandler = function() {
        if (app == "slidecasting") {
            ...
            $('.header_comments .toggleNotes').remove();
            $('.header_comments').append('<a href="#" class="toggleNotes">show/hide</a>').click(function() {
        ...
        if ($('.tweakdashboard .button.toggleMaximizeContent').hasClass('on')) {
            b.addClass('on');
            b.removeClass('off');
            sidebar('hide');
